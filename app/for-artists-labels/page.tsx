...
export default function ForArtistsLabelsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-r from-[#1A0000] via-[#0A0000] to-black text-white font-sans relative">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="mt-6 text-xl text-zinc-400">
              Reach millions of listeners by getting your music featured in viral Shorts.
            </motion.p>
            <motion.div variants={fadeIn} className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                asChild
              >
                <Link href="/label-submission">Submit Your Music</Link>
              </Button>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-zinc-400 max-w3xl mx-auto">
              Shorts Rev connects your music with YouTube Shorts creators, helping you reach new audiences and generate
              royalties through authentic promotion.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              className="bg-zinc-800/30 border border-zinc-700 rounded-xl p-6 text-center hover:border-red-500/50 transition-all duration-300"
            ...
            >
              ...
              <p className="text-zinc-400">
                Get your music heard by billions of YouTube Shorts viewers and unlock new revenue streams.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-400">
                Access detailed analytics and insights to optimize your music promotion strategy.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-400">
                Connect directly with YouTube Shorts creators and build lasting partnerships.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Stats Section - Unparalleled Reach */}
      <motion.section
        className="py-16 relative"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
      ...
      >
        <div className="container relative z-10 mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              Get your music featured in viral YouTube Shorts with our simple process
            </motion.p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <motion.div
              className="bg-zinc-800/30 border border-zinc-700 rounded-xl p-6 hover:bg-zinc-800/50 hover:border-red-500/50 transition-all duration-300 transform hover:scale-[1.02]"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
            >
              ...
              <h3 className="text-xl font-bold mb-3">Submit Music</h3>
              <p className="text-zinc-400">
                Upload your tracks through our simple submission process and join our music catalog
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-400">We match your music with relevant YouTube Shorts creators in our network</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-400">Creators produce engaging Shorts featuring your music to their audiences</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-400">Monitor performance and royalties through our comprehensive dashboard</p>
            </motion.div>
          </div>
        </div>
      </motion.section>

      {/* Why Partner With Shorts Rev Section */}
      <motion.section
        className="py-20 relative"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <p className="text-xl text-zinc-300 mb-8">
                Join the leading platform connecting artists and labels with YouTube Shorts creators to amplify your
                music and generate royalties.
              </p>
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <span className="text-zinc-300">Access to verified creators with millions of views monthly</span>
                </motion.div>
                <motion.div
                  className="flex items-center gap-3"
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                  <span className="text-zinc-300">Generate royalties from YouTube's Content ID system</span>
                </motion.div>
                <motion.div
                  className="flex items-center gap-3"
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0" />
                  <span className="text-zinc-300">Detailed analytics and performance tracking</span>
                </motion.div>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="bg-zinc-800/50 rounded-2xl border border-zinc-700 p-8 hover:bg-zinc-800/40 hover:border-red-500/50 transition-all duration-300">
                <h3 className="text-2xl font-bold mb-6 text-center">Music Promotion Benefits</h3>
                <div className="grid grid-cols-1 gap-4">
                  <motion.div
                    className="bg-zinc-800 border border-zinc-800 rounded-lg p-5 flex items-start gap-4 hover:bg-zinc-700/70 hover:border-red-500/50 transition-all duration-300"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.3, delay: 0.1 }}
                  >
                    ...
                    <div>
                      <h4 className="font-bold mb-1">Viral Exposure</h4>
                      <p className="text-zinc-400">Get your music featured in viral Shorts with millions of views</p>
                    </div>
                  </motion.div>
                  <motion.div
                    className="bg-zinc-800 border border-zinc-800 rounded-lg p-5 flex items-start gap-4 hover:bg-zinc-700/70 hover:border-red-500/50 transition-all duration-300"
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-bold mb-1">Royalty Generation</h4>
                      <p className="text-zinc-400">Earn revenue through YouTube's Content ID system</p>
                    </div>
                  </motion.div>
                  <motion.div
                    className="bg-zinc-800 border border-zinc-800 rounded-lg p-5 flex items-start gap-4 hover:bg-zinc-700/70 hover:border-red-500/50 transition-all duration-300"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400">
                        Connect with creators and audiences worldwide to expand your fanbase
                      </p>
                    </div>
                  </motion.div>
                </div>
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-xl text-zinc-300">
              Join thousands of artists and creators already earning with Shorts Rev's official music deals
            </motion.p>
