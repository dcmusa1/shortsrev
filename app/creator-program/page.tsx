...
import { ArrowLeft, CheckCircle, Youtube, Music, DollarSign } from "lucide-react"
        ...
        <section className="py-12 md:py-20">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-4xl space-y-4 text-center">
              ...
              <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Creator Program</h1>
              <p className="text-zinc-400 md:text-xl max-w-2xl mx-auto">
                Get paid to promote popular music in your YouTube Shorts
              </p>
            </div>

            <div className="mx-auto mt-12 max-w-4xl">
              <div className="bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-2xl border border-zinc-700 p-8 mb-12">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="md:w-1/2">
                    <h2 className="text-2xl font-bold mb-4">Earn While Creating</h2>
                    <p className="text-zinc-300 mb-6">
                      Join our Creator Program and get paid to promote popular music in your YouTube Shorts. We connect
                      you with trending tracks from major artists and labels, helping you create viral content while
                      earning revenue.
                    </p>
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0" />
                        <span className="text-zinc-300">Access to exclusive music</span>
                      </div>
                    </div>
                  </div>
                  <div className="md:w-1/2">
                    <div className="bg-zinc-800/70 rounded-xl overflow-hidden">
                      <Image
              ...
              <div className="grid gap-8 md:grid-cols-3 mb-12">
                <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3">Official YouTube Partner</h3>
                  <p className="text-zinc-400">
                    As an official YouTube partner, we provide unique monetization opportunities that aren't available
                    elsewhere.
                  </p>
                </div>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3">Licensed Music Access</h3>
                  <p className="text-zinc-400">
                ...
                <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3">Revenue Sharing</h3>
                  <p className="text-zinc-400">
                    Earn money from your content through our transparent revenue sharing model with regular monthly
                    payments.
                  </p>
                </div>
              </div>

              <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-8 mb-12">
                <h2 className="text-2xl font-bold mb-6">How It Works</h2>

                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    <div className="bg-red-500/20 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400">
                        Once approved, you'll gain access to our music library and creator dashboard. Our team will
                        provide you with all the necessary resources.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400">
                        Use our licensed music in your YouTube Shorts. Create engaging content that showcases the music
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400">
                        Earn revenue based on your content's performance. We provide monthly payments and detailed
                ...
                <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-zinc-300">Access to 10,000+ licensed tracks</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-zinc-300">No copyright strikes or claims</span>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-zinc-500 mt-4">Application review typically takes 2-3 business days</p>
              </div>
            </div>
          </div>
        </section>
